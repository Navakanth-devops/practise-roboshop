...
curl -o /home/Navakanth/tmp/catalogue.zip https://roboshop-artifacts.s3.amazonaws.com/catalogue-v3.zip &>>$log_file
...
sudo cp /$SCRIPT_DIR/mongo.repo /etc/yum.repos.d/mongo.repo
